    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values_preds.append(th.mean(values_pred).item())
        ...
        self.logger.record("train/values_preds", np.mean(values_preds))
        self.logger.record("train/rollout_returns", np.mean(rollout_returns))
